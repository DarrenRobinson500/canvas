...
class Db(models.Model):
    TYPE_CHOICES = [("role","role" ), ("busobj","busobj" ), ("obligation","obligation" ), ("process","process" ),
                    ("risk","risk" ), ("metric","metric" ), ("control","control" ), ("issue","issue" )]
    ...
    def colour(self):
        colour = {"role": "purple", "busobj": "blue", "obligation": "blue", "theme": "black",
                      "process": "green", "risk": "orange", "metric": "yellow", "control": "yellow"}
